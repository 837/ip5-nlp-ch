...
for taskID in GOLD_STANDARD_SET:
    ...
    # print(best_index)
    align.align_one_sentence_to_the_others(group, best_index, hun1toN, align.HUNALIGN, 0.5)
    align.align_one_sentence_to_the_others(group, best_index, bleu1toN, align.BLEUALIGN, 0.5)
    align.align_every_sentence_to_the_others(group, hunNtoN, align.HUNALIGN, 0.5)
    align.align_every_sentence_to_the_others(group, bleuNtoN, align.BLEUALIGN, 0.5)
